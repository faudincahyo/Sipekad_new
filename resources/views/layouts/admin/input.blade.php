            ...
            <div class="row-cols-7">
                ...
                <form class="form" action="{{ route('input.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group position-relative">
                        <div class="row">
                            <div class="col-3">
                                <button type="reset" style="background-color: rgb(95, 212, 95)" class="border-0 d-flex">
                            ...
                            <div class="col-3">
                                <button type="submit" style="background-color: rgb(95, 212, 95)"
                ...
                <table class="table" id="tableData">
                    ...
                    <tbody>
                        @foreach ($input as $item)
                            <tr>
                                <td class="d-flex">
                                    <form action="{{ route('input.destroy', $item->id) }}" method="POST" class="pe-2">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="border-0" style="background-color: rgb(95, 212, 95)">
                                            <img src="https://img.icons8.com/fluency-systems-filled/30/000000/delete.png" />
                                        </button>
                                    </form>

                                    <a href="{{ route('input.edit', $item->id) }}">
                                        <button  class="border-0" style="background-color: rgb(95, 212, 95)">
